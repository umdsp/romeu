...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'publications_type', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Type.description'
        db.alter_column(u'publications_type', 'description', self.gf('django.db.models.fields.CharField')(max_length=128))
