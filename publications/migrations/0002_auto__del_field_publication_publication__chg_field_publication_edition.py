...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Publication.publication'
        db.delete_column('publications_publication', 'publication')


        # Changing field 'Publication.edition'
        db.alter_column('publications_publication', 'edition', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Adding field 'Publication.publication'
        db.add_column('publications_publication', 'publication',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Publication.edition'
        db.alter_column('publications_publication', 'edition', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
