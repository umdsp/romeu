...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Publication', fields ['citekey']
        db.create_index(u'publications_publication', ['citekey'])

        # Adding index on 'Publication', fields ['year']
        db.create_index(u'publications_publication', ['year'])

        # Adding index on 'Publication', fields ['journal']
        db.create_index(u'publications_publication', ['journal'])


    def backwards(self, orm):
        # Removing index on 'Publication', fields ['journal']
        db.delete_index(u'publications_publication', ['journal'])

        # Removing index on 'Publication', fields ['year']
        db.delete_index(u'publications_publication', ['year'])

        # Removing index on 'Publication', fields ['citekey']
        db.delete_index(u'publications_publication', ['citekey'])
