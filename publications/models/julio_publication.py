...
from archive.models import WorkRecord 
"""
...
class Publication(models.Model):
	...
	book_title = models.CharField(max_length=255, null=True, blank=True, help_text=_("Only for works contained in a larger book"), verbose_name=_("book title"))
