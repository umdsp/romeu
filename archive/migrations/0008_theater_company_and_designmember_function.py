...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for obj in orm.Production.objects.all():
            if obj.theater_company:
                obj.theater_companies.add(obj.theater_company) 
                obj.save()
        for obj in orm.DesignMember.objects.all():
            if obj.function:
                obj.functions.add(obj.function)
                obj.save()
    ...
    def backwards(self, orm):
        ...
        raise RuntimeError("Cannot reverse this migration - 0008.")
