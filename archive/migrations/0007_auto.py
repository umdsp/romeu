...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field theater_company_new on 'Production'
        m2m_table_name = db.shorten_name('archive_production_theater_companies')
        ...
        # Adding M2M table for field function_new on 'DesignMember'
        m2m_table_name = db.shorten_name('archive_designmember_functions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('designmember', models.ForeignKey(orm['archive.designmember'], null=False)),
            ('designteamfunction', models.ForeignKey(orm['archive.designteamfunction'], null=False))
        ))
        db.create_unique(m2m_table_name, ['designmember_id', 'designteamfunction_id'])


    def backwards(self, orm):
        # Removing M2M table for field theater_company_new on 'Production'
        db.delete_table(db.shorten_name('archive_production_theater_companies'))

        # Removing M2M table for field function_new on 'DesignMember'
        db.delete_table(db.shorten_name('archive_designmember_functions'))
    ...
    models = {
        ...
        'archive.designmember': {
            ...
            'function': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'function'", 'to': "orm['archive.DesignTeamFunction']"}),
            'functions': ('django.db.models.fields.related.ManyToManyField', [], {'default': 'None', 'related_name': "'functions'", 'symmetrical': 'False', 'to': "orm['archive.DesignTeamFunction']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.Creator']"}),
            'production': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.Production']"})
        },
        ...
        'archive.digitalobject': {
            ...
            'related_creator': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'related_creator'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['archive.Creator']"}),
        ...
        'archive.production': {
            ...
            'theater_company': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'company_production'", 'null': 'True', 'to': "orm['archive.Creator']"}),
