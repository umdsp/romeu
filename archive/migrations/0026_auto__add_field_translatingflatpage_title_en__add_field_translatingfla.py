...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TranslatingFlatPage.title_en'
        db.add_column('archive_translatingflatpage', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'TranslatingFlatPage.title_es'
        db.add_column('archive_translatingflatpage', 'title_es', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'TranslatingFlatPage.content_en'
        db.add_column('archive_translatingflatpage', 'content_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'TranslatingFlatPage.content_es'
        db.add_column('archive_translatingflatpage', 'content_es', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TranslatingFlatPage.title_en'
        db.delete_column('archive_translatingflatpage', 'title_en')

        # Deleting field 'TranslatingFlatPage.title_es'
        db.delete_column('archive_translatingflatpage', 'title_es')

        # Deleting field 'TranslatingFlatPage.content_en'
        db.delete_column('archive_translatingflatpage', 'content_en')

        # Deleting field 'TranslatingFlatPage.content_es'
        db.delete_column('archive_translatingflatpage', 'content_es')
