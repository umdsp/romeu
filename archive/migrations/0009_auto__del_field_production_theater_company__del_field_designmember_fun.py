...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Production.theater_company'
        db.delete_column('archive_production', 'theater_company_id')

        # Deleting field 'DesignMember.function'
        db.delete_column('archive_designmember', 'function_id')


    def backwards(self, orm):
        # Adding field 'Production.theater_company'
        db.add_column('archive_production', 'theater_company',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='company_productions', null=True, to=orm['archive.Creator'], blank=True),
                      keep_default=False)

        # Adding field 'DesignMember.function'
        db.add_column('archive_designmember', 'function',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['archive.DesignTeamFunction']),
                      keep_default=False)
