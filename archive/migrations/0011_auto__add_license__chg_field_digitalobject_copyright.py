...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('archive', ['License'])

        # Renaming column for 'DigitalObject.copyright' to match new field type.
        # db.rename_column('archive_digitalobject', 'copyright', 'copyright_id')
        # Changing field 'DigitalObject.copyright'
        # db.alter_column('archive_digitalobject', 'copyright_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.License'], null=True))

	db.delete_column('archive_digitalobject', 'copyright')
	db.add_column('archive_digitalobject', 'copyright', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.License'], null=True))

        # Adding index on 'DigitalObject', fields ['copyright']
	# db.create_index('archive_digitalobject', ['copyright_id'])


    def backwards(self, orm):
        
        # Removing index on 'DigitalObject', fields ['copyright']
        db.delete_index('archive_digitalobject', ['copyright_id'])

        # Deleting model 'License'
        db.delete_table('archive_license')

        # Renaming column for 'DigitalObject.copyright' to match new field type.
        db.rename_column('archive_digitalobject', 'copyright_id', 'copyright')
        # Changing field 'DigitalObject.copyright'
        db.alter_column('archive_digitalobject', 'copyright', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'archive.digitalobject': {
            ...
            'copyright': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.License']", 'null': 'True', 'blank': 'True'}),
