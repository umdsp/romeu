...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DigitalObject.language'
        db.delete_column('archive_digitalobject', 'language_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DigitalObject.language'
        db.add_column('archive_digitalobject', 'language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.Language'], null=True, blank=True), keep_default=False)
