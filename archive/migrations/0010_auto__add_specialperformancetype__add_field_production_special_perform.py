...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('archive_specialperformancetype', (
        ...
        db.send_create_signal('archive', ['SpecialPerformanceType'])

        # Adding field 'Production.special_performance_type_tmp'
        db.add_column('archive_production', 'special_performance_type_tmp',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['archive.SpecialPerformanceType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SpecialPerformanceType'
        db.delete_table('archive_specialperformancetype')

        # Deleting field 'Production.special_performance_type_tmp'
        db.delete_column('archive_production', 'special_performance_type_tmp_id')
    ...
    models = {
        ...
        'archive.production': {
            ...
            'special_performance_type_tmp': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['archive.SpecialPerformanceType']", 'null': 'True', 'blank': 'True'}),
