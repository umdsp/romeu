...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DigitalObject.permission_form'
        db.add_column('archive_digitalobject', 'permission_form', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DigitalObject.permission_form'
        db.delete_column('archive_digitalobject', 'permission_form')
