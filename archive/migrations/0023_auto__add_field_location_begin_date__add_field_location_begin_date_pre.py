...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.begin_date'
        db.add_column('archive_location', 'begin_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Location.begin_date_precision'
        db.add_column('archive_location', 'begin_date_precision', self.gf('django.db.models.fields.CharField')(default=u'y', max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'Location.begin_date_BC'
        db.add_column('archive_location', 'begin_date_BC', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Location.end_date'
        db.add_column('archive_location', 'end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Location.end_date_precision'
        db.add_column('archive_location', 'end_date_precision', self.gf('django.db.models.fields.CharField')(default=u'y', max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'Location.end_date_BC'
        db.add_column('archive_location', 'end_date_BC', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.begin_date'
        db.delete_column('archive_location', 'begin_date')

        # Deleting field 'Location.begin_date_precision'
        db.delete_column('archive_location', 'begin_date_precision')

        # Deleting field 'Location.begin_date_BC'
        db.delete_column('archive_location', 'begin_date_BC')

        # Deleting field 'Location.end_date'
        db.delete_column('archive_location', 'end_date')

        # Deleting field 'Location.end_date_precision'
        db.delete_column('archive_location', 'end_date_precision')

        # Deleting field 'Location.end_date_BC'
        db.delete_column('archive_location', 'end_date_BC')
