...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('archive_creator', (
            ...
            ('profiler_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('profiler_entry_date', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        ...
        db.create_table('archive_production', (
            ...
            ('needs_editing', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('theater_company', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='company_productions', null=True, to=orm['archive.Creator'])),
            ('profiler_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('profiler_entry_date', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        ...
        db.create_table('archive_digitalobject', (
            ...
            ('marks', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.create_table('archive_translatingflatpage', (
        ...
        db.send_create_signal('archive', ['TranslatingFlatPage'])

        # Adding model 'HomePageInfo'
        db.create_table('archive_homepageinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('archive', ['HomePageInfo'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('archive_translatingflatpage')

        # Deleting model 'HomePageInfo'
        db.delete_table('archive_homepageinfo')
