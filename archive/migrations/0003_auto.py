...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('archive_digitalobject_related_award')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('digitalobject', models.ForeignKey(orm['archive.digitalobject'], null=False)),
            ('awardcandidate', models.ForeignKey(orm['archive.awardcandidate'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('archive_digitalobject_related_award'))
