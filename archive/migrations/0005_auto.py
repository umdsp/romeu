...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('archive_festivaloccurrence_primary_publications')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('archive_festivaloccurrence_primary_publications'))
