...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.biblio_text'
        db.add_column('archive_production', 'biblio_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Production.biblio_text_es'
        db.add_column('archive_production', 'biblio_text_es', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Creator.biblio_text'
        db.add_column('archive_creator', 'biblio_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Creator.biblio_text_es'
        db.add_column('archive_creator', 'biblio_text_es', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Creator.secondary_biblio_text'
        db.add_column('archive_creator', 'secondary_biblio_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Creator.secondary_biblio_text_en'
        db.add_column('archive_creator', 'secondary_biblio_text_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Creator.profiler_name'
        db.add_column('archive_creator', 'profiler_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Creator.profiler_entry_date'
        db.add_column('archive_creator', 'profiler_entry_date', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'WorkRecord.biblio_text'
        db.add_column('archive_workrecord', 'biblio_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'WorkRecord.biblio_text_es'
        db.add_column('archive_workrecord', 'biblio_text_es', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'WorkRecord.secondary_biblio_text'
        db.add_column('archive_workrecord', 'secondary_biblio_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'WorkRecord.secondary_biblio_text_en'
        db.add_column('archive_workrecord', 'secondary_biblio_text_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Production.biblio_text'
        db.delete_column('archive_production', 'biblio_text')

        # Deleting field 'Production.biblio_text_es'
        db.delete_column('archive_production', 'biblio_text_es')

        # Deleting field 'Creator.biblio_text'
        db.delete_column('archive_creator', 'biblio_text')

        # Deleting field 'Creator.biblio_text_es'
        db.delete_column('archive_creator', 'biblio_text_es')

        # Deleting field 'Creator.secondary_biblio_text'
        db.delete_column('archive_creator', 'secondary_biblio_text')

        # Deleting field 'Creator.secondary_biblio_text_en'
        db.delete_column('archive_creator', 'secondary_biblio_text_en')

        # Deleting field 'Creator.profiler_name'
        db.delete_column('archive_creator', 'profiler_name')

        # Deleting field 'Creator.profiler_entry_date'
        db.delete_column('archive_creator', 'profiler_entry_date')

        # Deleting field 'WorkRecord.biblio_text'
        db.delete_column('archive_workrecord', 'biblio_text')

        # Deleting field 'WorkRecord.biblio_text_es'
        db.delete_column('archive_workrecord', 'biblio_text_es')

        # Deleting field 'WorkRecord.secondary_biblio_text'
        db.delete_column('archive_workrecord', 'secondary_biblio_text')

        # Deleting field 'WorkRecord.secondary_biblio_text_en'
        db.delete_column('archive_workrecord', 'secondary_biblio_text_en')
    ...
    models = {
        ...
        'archive.creator': {
            ...
            'secondary_biblio_text_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'archive.digitalobject': {
            ...
            'marks': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
