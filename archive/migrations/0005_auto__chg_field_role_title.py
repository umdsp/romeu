...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('archive_role', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Role.title'
        db.alter_column('archive_role', 'title', self.gf('django.db.models.fields.CharField')(max_length=60))
