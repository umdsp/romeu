...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PhysicalObjectType.slug'
        db.add_column('archive_physicalobjecttype', 'slug', self.gf('django.db.models.fields.CharField')(default=' ', max_length=200), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'PhysicalObjectType.slug'
        db.delete_column('archive_physicalobjecttype', 'slug')
