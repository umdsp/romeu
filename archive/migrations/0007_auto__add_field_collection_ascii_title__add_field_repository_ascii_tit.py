...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collection.ascii_title'
        db.add_column('archive_collection', 'ascii_title', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'Repository.ascii_title'
        db.add_column('archive_repository', 'ascii_title', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'DigitalObject.ascii_title'
        db.add_column('archive_digitalobject', 'ascii_title', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'FestivalOccurrence.ascii_title'
        db.add_column('archive_festivaloccurrence', 'ascii_title', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Collection.ascii_title'
        db.delete_column('archive_collection', 'ascii_title')

        # Deleting field 'Repository.ascii_title'
        db.delete_column('archive_repository', 'ascii_title')

        # Deleting field 'DigitalObject.ascii_title'
        db.delete_column('archive_digitalobject', 'ascii_title')

        # Deleting field 'FestivalOccurrence.ascii_title'
        db.delete_column('archive_festivaloccurrence', 'ascii_title')
