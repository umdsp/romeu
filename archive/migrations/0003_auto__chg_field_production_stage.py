...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Production.stage'
        db.alter_column('archive_production', 'stage_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['archive.Stage'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Production.stage'
        db.alter_column('archive_production', 'stage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.Stage'], null=True))
