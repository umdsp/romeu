...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkRecord.publication_date'
        db.add_column('archive_workrecord', 'publication_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'WorkRecord.publication_date_precision'
        db.add_column('archive_workrecord', 'publication_date_precision', self.gf('django.db.models.fields.CharField')(default=u'y', max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'WorkRecord.publication_date_BC'
        db.add_column('archive_workrecord', 'publication_date_BC', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WorkRecord.publication_date'
        db.delete_column('archive_workrecord', 'publication_date')

        # Deleting field 'WorkRecord.publication_date_precision'
        db.delete_column('archive_workrecord', 'publication_date_precision')

        # Deleting field 'WorkRecord.publication_date_BC'
        db.delete_column('archive_workrecord', 'publication_date_BC')
