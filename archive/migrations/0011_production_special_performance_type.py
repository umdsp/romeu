...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for r in SPECIAL_PERFORMANCE_CHOICES:
            print r[0].title()
            try:
                is_there = orm.SpecialPerformanceType.objects.get(type=r[0].title())
            except:
                spt = orm.SpecialPerformanceType()
                spt.type = r[0].title() 
                spt.save()                
        
        for obj in orm.Production.objects.all():
            if obj.special_performance_type:
                spt = orm.SpecialPerformanceType.objects.get(type=obj.special_performance_type.title())
                obj.special_performance_type_tmp = spt
                obj.save()
    ...
    def backwards(self, orm):
        ...
        raise RuntimeError("Cannot reverse this migration - 0011.")
