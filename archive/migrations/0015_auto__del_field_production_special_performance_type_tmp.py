...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('archive_production', 'special_performance_type_tmp',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='special_performance_type_tmp', null=True, to=orm['archive.SpecialPerformanceType'], blank=True),
                      keep_default=False)
