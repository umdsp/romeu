...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'License.title_en'
        db.add_column('archive_license', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'License.title_es'
        db.add_column('archive_license', 'title_es', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'License.description_en'
        db.add_column('archive_license', 'description_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'License.description_es'
        db.add_column('archive_license', 'description_es', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'License.title_en'
        db.delete_column('archive_license', 'title_en')

        # Deleting field 'License.title_es'
        db.delete_column('archive_license', 'title_es')

        # Deleting field 'License.description_en'
        db.delete_column('archive_license', 'description_en')

        # Deleting field 'License.description_es'
        db.delete_column('archive_license', 'description_es')
