...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DigitalObject.phys_obj_location'
        db.delete_column(u'archive_digitalobject', 'phys_obj_location_id')


    def backwards(self, orm):
        # Adding field 'DigitalObject.phys_obj_location'
        db.add_column(u'archive_digitalobject', 'phys_obj_location',
