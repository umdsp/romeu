...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RelatedWork.work_1'
        db.delete_column('archive_relatedwork', 'work_1_id')

        # Deleting field 'RelatedWork.work_2'
        db.delete_column('archive_relatedwork', 'work_2_id')

        # Adding field 'RelatedWork.first_work'
        db.add_column('archive_relatedwork', 'first_work', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='first_work_to', to=orm['archive.WorkRecord']), keep_default=False)

        # Adding field 'RelatedWork.second_work'
        db.add_column('archive_relatedwork', 'second_work', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='second_work_to', to=orm['archive.WorkRecord']), keep_default=False)

        # Deleting field 'RelatedCreator.creator_1'
        db.delete_column('archive_relatedcreator', 'creator_1_id')

        # Deleting field 'RelatedCreator.creator_2'
        db.delete_column('archive_relatedcreator', 'creator_2_id')

        # Adding field 'RelatedCreator.first_creator'
        db.add_column('archive_relatedcreator', 'first_creator', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='first_creator_to', to=orm['archive.Creator']), keep_default=False)

        # Adding field 'RelatedCreator.second_creator'
        db.add_column('archive_relatedcreator', 'second_creator', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='second_creator_to', to=orm['archive.Creator']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'RelatedWork.work_1'
        raise RuntimeError("Cannot reverse this migration. 'RelatedWork.work_1' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'RelatedWork.work_2'
        raise RuntimeError("Cannot reverse this migration. 'RelatedWork.work_2' and its values cannot be restored.")

        # Deleting field 'RelatedWork.first_work'
        db.delete_column('archive_relatedwork', 'first_work_id')

        # Deleting field 'RelatedWork.second_work'
        db.delete_column('archive_relatedwork', 'second_work_id')

        # User chose to not deal with backwards NULL issues for 'RelatedCreator.creator_1'
        raise RuntimeError("Cannot reverse this migration. 'RelatedCreator.creator_1' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'RelatedCreator.creator_2'
        raise RuntimeError("Cannot reverse this migration. 'RelatedCreator.creator_2' and its values cannot be restored.")

        # Deleting field 'RelatedCreator.first_creator'
        db.delete_column('archive_relatedcreator', 'first_creator_id')

        # Deleting field 'RelatedCreator.second_creator'
        db.delete_column('archive_relatedcreator', 'second_creator_id')
