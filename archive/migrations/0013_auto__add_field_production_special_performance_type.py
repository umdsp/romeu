...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Production.special_performance_type'
        db.add_column('archive_production', 'special_performance_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='special_performance_type', null=True, blank=True, to=orm['archive.SpecialPerformanceType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Production.special_performance_type'
        db.delete_column('archive_production', 'special_performance_type_id')
    ...
    models = {
        ...
        'archive.production': {
            ...
            'special_performance_type_tmp': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'special_performance_type_tmp'", 'null': 'True', 'blank': 'True', 'to': "orm['archive.SpecialPerformanceType']"}),
