...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DigitalObject.restricted'
        db.add_column('archive_digitalobject', 'restricted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'DigitalObject.restricted_description'
        db.add_column('archive_digitalobject', 'restricted_description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DigitalObject.ready_to_stream'
        db.add_column('archive_digitalobject', 'ready_to_stream', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'DigitalObject.poster_image'
        db.add_column('archive_digitalobject', 'poster_image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DigitalObject.restricted'
        db.delete_column('archive_digitalobject', 'restricted')

        # Deleting field 'DigitalObject.restricted_description'
        db.delete_column('archive_digitalobject', 'restricted_description')

        # Deleting field 'DigitalObject.ready_to_stream'
        db.delete_column('archive_digitalobject', 'ready_to_stream')

        # Deleting field 'DigitalObject.poster_image'
        db.delete_column('archive_digitalobject', 'poster_image')
