...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.profiler_name'
        db.add_column('archive_production', 'profiler_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Production.profiler_entry_date'
        db.add_column('archive_production', 'profiler_entry_date', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FestivalOccurrence.profiler_name'
        db.add_column('archive_festivaloccurrence', 'profiler_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Production.profiler_name'
        db.delete_column('archive_production', 'profiler_name')

        # Deleting field 'Production.profiler_entry_date'
        db.delete_column('archive_production', 'profiler_entry_date')

        # Deleting field 'FestivalOccurrence.profiler_name'
        db.delete_column('archive_festivaloccurrence', 'profiler_name')
