...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Collection.summary_es'
        db.delete_column('archive_collection', 'summary_es')

        # Deleting field 'Collection.summary'
        db.delete_column('archive_collection', 'summary')

        # Deleting field 'Collection.summary_en'
        db.delete_column('archive_collection', 'summary_en')


    def backwards(self, orm):
        # Adding field 'Collection.summary_es'
        db.add_column('archive_collection', 'summary_es',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Collection.summary'
        db.add_column('archive_collection', 'summary',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Collection.summary_en'
        db.add_column('archive_collection', 'summary_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
