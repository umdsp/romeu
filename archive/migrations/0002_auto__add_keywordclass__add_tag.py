...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KeywordClass'
        db.create_table('archive_keywordclass', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('archive', ['KeywordClass'])

        # Adding model 'Tag'
        db.create_table('archive_tag', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True)),
        ))
        db.send_create_signal('archive', ['Tag'])

        # Adding M2M table for field tags on 'BibliographicRecord'
        db.create_table('archive_bibliographicrecord_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bibliographicrecord', models.ForeignKey(orm['archive.bibliographicrecord'], null=False)),
            ('tag', models.ForeignKey(orm['archive.tag'], null=False))
        ))
        db.create_unique('archive_bibliographicrecord_tags', ['bibliographicrecord_id', 'tag_id'])


    def backwards(self, orm):
        # Deleting model 'KeywordClass'
        db.delete_table('archive_keywordclass')

        # Deleting model 'Tag'
        db.delete_table('archive_tag')

        # Removing M2M table for field tags on 'BibliographicRecord'
        db.delete_table('archive_bibliographicrecord_tags')
    ...
    models = {
        ...
        'archive.bibliographicrecord': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['archive.Tag']", 'symmetrical': 'False'}),
        ...
        'archive.keywordclass': {
            'Meta': {'ordering': "['name']", 'object_name': 'KeywordClass'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'archive.language': {
