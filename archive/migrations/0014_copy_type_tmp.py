...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for obj in orm.Production.objects.all():
            if obj.special_performance_type_tmp:
                obj.special_performance_type = obj.special_performance_type_tmp
                obj.save()
    ...
    def backwards(self, orm):
        ...
        raise RuntimeError("Cannot reverse this migration - 0013.")
