...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.subtitle'
        db.add_column('archive_production', 'subtitle', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Changing field 'Production.title'
        db.alter_column('archive_production', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Production.ascii_title'
        db.alter_column('archive_production', 'ascii_title', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Deleting field 'Production.subtitle'
        db.delete_column('archive_production', 'subtitle')

        # Changing field 'Production.title'
        db.alter_column('archive_production', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Production.ascii_title'
        db.alter_column('archive_production', 'ascii_title', self.gf('django.db.models.fields.CharField')(max_length=200))
