...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DigitalObject.rights_holders'
        db.add_column('archive_digitalobject', 'rights_holders', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DigitalObject.rights_holders'
        db.delete_column('archive_digitalobject', 'rights_holders')
    ...
    models = {
        ...
        'archive.digitalobject': {
            ...
            'license_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['archive.License']", 'null': 'True', 'blank': 'True'}),
