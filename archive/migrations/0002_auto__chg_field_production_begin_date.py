...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Production.begin_date'
        db.alter_column('archive_production', 'begin_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Production.begin_date'
        raise RuntimeError("Cannot reverse this migration. 'Production.begin_date' and its values cannot be restored.")
