...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Creator.creator_display_name'
        db.add_column('archive_creator', 'creator_display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Creator.creator_display_ascii_name'
        db.add_column('archive_creator', 'creator_display_ascii_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Creator.creator_display_name'
        db.delete_column('archive_creator', 'creator_display_name')

        # Deleting field 'Creator.creator_display_ascii_name'
        db.delete_column('archive_creator', 'creator_display_ascii_name')
