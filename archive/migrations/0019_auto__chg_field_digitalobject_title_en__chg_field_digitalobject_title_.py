...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DigitalObject.title_en'
        db.alter_column('archive_digitalobject', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DigitalObject.title'
        db.alter_column('archive_digitalobject', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'DigitalObject.measurements'
        db.alter_column('archive_digitalobject', 'measurements', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        ...
        # Changing field 'DigitalObject.donor'
        db.alter_column('archive_digitalobject', 'donor', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DigitalObject.series_name'
        db.alter_column('archive_digitalobject', 'series_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DigitalObject.title_es'
        db.alter_column('archive_digitalobject', 'title_es', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DigitalObject.subseries_name'
        db.alter_column('archive_digitalobject', 'subseries_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DigitalObject.folder_date'
        db.alter_column('archive_digitalobject', 'folder_date', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DigitalObject.folder_name'
        db.alter_column('archive_digitalobject', 'folder_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'DigitalObject.title_en'
        db.alter_column('archive_digitalobject', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'DigitalObject.title'
        db.alter_column('archive_digitalobject', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DigitalObject.measurements'
        db.alter_column('archive_digitalobject', 'measurements', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'DigitalObject.marks'
        db.alter_column('archive_digitalobject', 'marks', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'DigitalObject.donor'
        db.alter_column('archive_digitalobject', 'donor', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'DigitalObject.series_name'
        db.alter_column('archive_digitalobject', 'series_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'DigitalObject.title_es'
        db.alter_column('archive_digitalobject', 'title_es', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'DigitalObject.subseries_name'
        db.alter_column('archive_digitalobject', 'subseries_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'DigitalObject.folder_date'
        db.alter_column('archive_digitalobject', 'folder_date', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'DigitalObject.folder_name'
        db.alter_column('archive_digitalobject', 'folder_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
