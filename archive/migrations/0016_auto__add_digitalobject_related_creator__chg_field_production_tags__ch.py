...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('archive_workrecord', 'performance_rights_es', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'WorkRecord.performance_rights_en'
        db.alter_column('archive_workrecord', 'performance_rights_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'WorkRecord.performance_rights'
        db.alter_column('archive_workrecord', 'performance_rights', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'WorkRecord.publication_rights_es'
        db.alter_column('archive_workrecord', 'publication_rights_es', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'WorkRecord.publication_rights'
        db.alter_column('archive_workrecord', 'publication_rights', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'WorkRecord.publication_rights_en'
        db.alter_column('archive_workrecord', 'publication_rights_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
