...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DigitalObject.phys_obj_city'
        db.add_column(u'archive_digitalobject', 'phys_obj_city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.City'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Creator.location'
        db.delete_column(u'archive_creator', 'location_id')

        # Deleting field 'Creator.death_location'
        db.delete_column(u'archive_creator', 'death_location_id')

        # Deleting field 'Creator.birth_location'
        db.delete_column(u'archive_creator', 'birth_location_id')


    def backwards(self, orm):
        # Deleting field 'DigitalObject.phys_obj_city'
        db.delete_column(u'archive_digitalobject', 'phys_obj_city_id')

        # Adding field 'Creator.location'
        db.add_column(u'archive_creator', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.Location'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Creator.death_location'
        db.add_column(u'archive_creator', 'death_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='died_here', null=True, to=orm['archive.Location'], blank=True),
                      keep_default=False)

        # Adding field 'Creator.birth_location'
        db.add_column(u'archive_creator', 'birth_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='born_here', null=True, to=orm['archive.Location'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'archive.digitalobject': {
            ...
            'phys_obj_city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['archive.City']", 'null': 'True', 'blank': 'True'}),
