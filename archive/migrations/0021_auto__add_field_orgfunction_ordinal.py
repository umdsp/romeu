...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrgFunction.ordinal'
        db.add_column('archive_orgfunction', 'ordinal',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrgFunction.ordinal'
        db.delete_column('archive_orgfunction', 'ordinal')
