...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DigitalObject.copyright'
        db.delete_column('archive_digitalobject', 'copyright_id')

        # Deleting field 'DigitalObject.rights'
        db.delete_column('archive_digitalobject', 'rights')

        # Adding field 'DigitalObject.rights_statement'
        db.add_column('archive_digitalobject', 'rights_statement', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DigitalObject.license_type'
        db.add_column('archive_digitalobject', 'license_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.License'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DigitalObject.copyright'
        db.add_column('archive_digitalobject', 'copyright', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.License'], null=True, blank=True), keep_default=False)

        # Adding field 'DigitalObject.rights'
        db.add_column('archive_digitalobject', 'rights', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'DigitalObject.rights_statement'
        db.delete_column('archive_digitalobject', 'rights_statement')

        # Deleting field 'DigitalObject.license_type'
        db.delete_column('archive_digitalobject', 'license_type_id')
    ...
    models = {
        ...
        'archive.digitalobject': {
            ...
            'license_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.License']", 'null': 'True', 'blank': 'True'}),
            ...
            'rights_statement': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
