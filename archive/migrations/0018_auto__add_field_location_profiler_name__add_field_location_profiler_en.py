...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.profiler_name'
        db.add_column('archive_location', 'profiler_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.profiler_entry_date'
        db.add_column('archive_location', 'profiler_entry_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AwardCandidate.profiler_name'
        db.add_column('archive_awardcandidate', 'profiler_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AwardCandidate.profiler_entry_date'
        db.add_column('archive_awardcandidate', 'profiler_entry_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Award.award_org'
        db.alter_column('archive_award', 'award_org', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
        # Adding field 'WorkRecord.profiler_name'
        db.add_column('archive_workrecord', 'profiler_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkRecord.profiler_entry_date'
        db.add_column('archive_workrecord', 'profiler_entry_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FestivalOccurrence.profiler_entry_date'
        db.add_column('archive_festivaloccurrence', 'profiler_entry_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.profiler_name'
        db.delete_column('archive_location', 'profiler_name')

        # Deleting field 'Location.profiler_entry_date'
        db.delete_column('archive_location', 'profiler_entry_date')

        # Deleting field 'AwardCandidate.profiler_name'
        db.delete_column('archive_awardcandidate', 'profiler_name')

        # Deleting field 'AwardCandidate.profiler_entry_date'
        db.delete_column('archive_awardcandidate', 'profiler_entry_date')


        # Changing field 'Award.award_org'
        db.alter_column('archive_award', 'award_org', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
        # Deleting field 'WorkRecord.profiler_name'
        db.delete_column('archive_workrecord', 'profiler_name')

        # Deleting field 'WorkRecord.profiler_entry_date'
        db.delete_column('archive_workrecord', 'profiler_entry_date')

        # Deleting field 'FestivalOccurrence.profiler_entry_date'
        db.delete_column('archive_festivaloccurrence', 'profiler_entry_date')
    ...
    models = {
        ...
        'archive.awardcandidate': {
            ...
            'festival': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'festival'", 'null': 'True', 'blank': 'True', 'to': "orm['archive.Festival']"}),
            'has_attention': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'notes_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'notes_es': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'place'", 'null': 'True', 'blank': 'True', 'to': "orm['archive.Location']"}),
            'production': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'production'", 'null': 'True', 'blank': 'True', 'to': "orm['archive.Production']"}),
            ...
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'recipient'", 'null': 'True', 'to': "orm['archive.Creator']"}),
            'result': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'work_record': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'work_record'", 'null': 'True', 'blank': 'True', 'to': "orm['archive.WorkRecord']"}),
        ...
        'archive.castmember': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.Creator']"}),
            'production': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.Production']"}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['archive.Role']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'archive.designmember': {
            ...
            'functions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'functions'", 'symmetrical': 'False', 'to': "orm['archive.DesignTeamFunction']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.Creator']"}),
            'production': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.Production']"})
        },
        ...
        'archive.digitalobject': {
            ...
            'related_award': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'related_award'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['archive.AwardCandidate']"}),
            'related_creator': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_creator'", 'to': "orm['archive.Creator']", 'through': "orm['archive.DigitalObject_Related_Creator']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'related_festival': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'related_festival'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['archive.FestivalOccurrence']"}),
            'related_production': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'related_production'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['archive.Production']"}),
            'related_venue': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'related_venue'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['archive.Location']"}),
            'related_work': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'related_work'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['archive.WorkRecord']"}),
        ...
        'archive.digitalobject_related_creator': {
            'Meta': {'object_name': 'DigitalObject_Related_Creator'},
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.Creator']"}),
            'digitalobject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.DigitalObject']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        'archive.production': {
            ...
            'special_performance_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'special_performance_type'", 'null': 'True', 'blank': 'True', 'to': "orm['archive.SpecialPerformanceType']"}),
            ...
            'theater_companies': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'company_productions'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['archive.Creator']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'title_variants': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
        ...
        'archive.specialperformancetype': {
