...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DigitalObject.license_type'
        db.alter_column('archive_digitalobject', 'license_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.License']))


    def backwards(self, orm):
        
        # Changing field 'DigitalObject.license_type'
        db.alter_column('archive_digitalobject', 'license_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.License'], null=True))
