...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Location.state_en'
        db.delete_column(u'archive_location', 'state_en')

        # Deleting field 'Location.state_es'
        db.delete_column(u'archive_location', 'state_es')

        # Deleting field 'Location.state'
        db.delete_column(u'archive_location', 'state')


    def backwards(self, orm):
        # Adding field 'Location.state_en'
        db.add_column(u'archive_location', 'state_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.state_es'
        db.add_column(u'archive_location', 'state_es',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.state'
        db.add_column(u'archive_location', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
