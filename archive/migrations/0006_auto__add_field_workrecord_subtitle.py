...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkRecord.subtitle'
        db.add_column('archive_workrecord', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkRecord.subtitle'
        db.delete_column('archive_workrecord', 'subtitle')
    ...
    models = {
        ...
        'archive.designmember': {
            ...
            'function': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['archive.DesignTeamFunction']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.Creator']"}),
            'production': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.Production']"})
        },
