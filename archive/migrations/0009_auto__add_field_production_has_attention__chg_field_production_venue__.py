...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.has_attention'
        db.add_column('archive_production', 'has_attention', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Production.venue'
        db.alter_column('archive_production', 'venue_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['archive.Location']))

        # Adding field 'Location.has_attention'
        db.add_column('archive_location', 'has_attention', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'AwardCandidate.has_attention'
        db.add_column('archive_awardcandidate', 'has_attention', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Collection.has_attention'
        db.add_column('archive_collection', 'has_attention', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Stage.has_attention'
        db.add_column('archive_stage', 'has_attention', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Repository.has_attention'
        db.add_column('archive_repository', 'has_attention', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'DigitalObject.has_attention'
        db.add_column('archive_digitalobject', 'has_attention', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Creator.has_attention'
        db.add_column('archive_creator', 'has_attention', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'WorkRecord.has_attention'
        db.add_column('archive_workrecord', 'has_attention', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'FestivalOccurrence.has_attention'
        db.add_column('archive_festivaloccurrence', 'has_attention', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Production.has_attention'
        db.delete_column('archive_production', 'has_attention')

        # Changing field 'Production.venue'
        db.alter_column('archive_production', 'venue_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['archive.Location']))

        # Deleting field 'Location.has_attention'
        db.delete_column('archive_location', 'has_attention')

        # Deleting field 'AwardCandidate.has_attention'
        db.delete_column('archive_awardcandidate', 'has_attention')

        # Deleting field 'Collection.has_attention'
        db.delete_column('archive_collection', 'has_attention')

        # Deleting field 'Stage.has_attention'
        db.delete_column('archive_stage', 'has_attention')

        # Deleting field 'Repository.has_attention'
        db.delete_column('archive_repository', 'has_attention')

        # Deleting field 'DigitalObject.has_attention'
        db.delete_column('archive_digitalobject', 'has_attention')

        # Deleting field 'Creator.has_attention'
        db.delete_column('archive_creator', 'has_attention')

        # Deleting field 'WorkRecord.has_attention'
        db.delete_column('archive_workrecord', 'has_attention')

        # Deleting field 'FestivalOccurrence.has_attention'
        db.delete_column('archive_festivaloccurrence', 'has_attention')
    ...
    models = {
        ...
        'archive.production': {
            ...
            'stage': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': "orm['archive.Stage']", 'null': 'True', 'blank': 'True'}),
