...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Festival.notes'
        db.add_column('archive_festival', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Festival.attention'
        db.add_column('archive_festival', 'attention', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'FestivalOccurrence.venue'
        db.delete_column('archive_festivaloccurrence', 'venue_id')

        # Adding field 'FestivalOccurrence.edu_program'
        db.add_column('archive_festivaloccurrence', 'edu_program', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'FestivalOccurrence.announcement'
        db.add_column('archive_festivaloccurrence', 'announcement', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'FestivalOccurrence.website'
        db.add_column('archive_festivaloccurrence', 'website', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding M2M table for field venue on 'FestivalOccurrence'
        db.create_table('archive_festivaloccurrence_venue', (
        ...
        db.create_unique('archive_festivaloccurrence_venue', ['festivaloccurrence_id', 'location_id'])


    def backwards(self, orm):
        
        # Deleting field 'Festival.notes'
        db.delete_column('archive_festival', 'notes')

        # Deleting field 'Festival.attention'
        db.delete_column('archive_festival', 'attention')

        # User chose to not deal with backwards NULL issues for 'FestivalOccurrence.venue'
        raise RuntimeError("Cannot reverse this migration. 'FestivalOccurrence.venue' and its values cannot be restored.")

        # Deleting field 'FestivalOccurrence.edu_program'
        db.delete_column('archive_festivaloccurrence', 'edu_program')

        # Deleting field 'FestivalOccurrence.announcement'
        db.delete_column('archive_festivaloccurrence', 'announcement')

        # Deleting field 'FestivalOccurrence.website'
        db.delete_column('archive_festivaloccurrence', 'website')

        # Removing M2M table for field venue on 'FestivalOccurrence'
        db.delete_table('archive_festivaloccurrence_venue')
