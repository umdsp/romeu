...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DigitalObject.title_variants_en'
        db.add_column('archive_digitalobject', 'title_variants_en',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DigitalObject.title_variants_es'
        db.add_column('archive_digitalobject', 'title_variants_es',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DigitalObject.title_variants_en'
        db.delete_column('archive_digitalobject', 'title_variants_en')

        # Deleting field 'DigitalObject.title_variants_es'
        db.delete_column('archive_digitalobject', 'title_variants_es')
