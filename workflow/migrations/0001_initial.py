...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Queue'
        db.create_table('workflow_queue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('workflow', ['Queue'])

        # Adding model 'QueueItem'
        db.create_table('workflow_queueitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='queue_item', to=orm['archive.DigitalObject'])),
            ('phys_assessed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('captured', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('post_proc', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('supervisor_qc', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('edited', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('metadata', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('prepped', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('high_priority', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('queue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='queue_items', to=orm['workflow.Queue'])),
        ))
        db.send_create_signal('workflow', ['QueueItem'])


    def backwards(self, orm):
        
        # Deleting model 'Queue'
        db.delete_table('workflow_queue')

        # Deleting model 'QueueItem'
        db.delete_table('workflow_queueitem')
    ...
    models = {
        ...
        'workflow.queueitem': {
            ...
            'captured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metadata': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'queue_item'", 'to': "orm['archive.DigitalObject']"}),
            'phys_assessed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'post_proc': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'prepped': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'queue': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'queue_items'", 'to': "orm['workflow.Queue']"}),
            'supervisor_qc': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
